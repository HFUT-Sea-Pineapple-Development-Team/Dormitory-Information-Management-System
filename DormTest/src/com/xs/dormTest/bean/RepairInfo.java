...
public class RepairInfo {
	...
	public RepairInfo(int id, String stu_id, String name, int build_id, int room_id, Date report_time, String reason,
			Date repair_time, String idea, String is_satisfied, String tel, String is_finished, String repair_report,
			Room room) {
		super();
		this.id = id;
		this.stu_id = stu_id;
	...
	public String toString() {
		return "RepairInfo [id=" + id + ", stu_id=" + stu_id + ", name=" + name + ", build_id=" + build_id
				+ ", room_id=" + room_id + ", report_time=" + report_time + ", reason=" + reason + ", repair_time="
				+ repair_time + ", idea=" + idea + ", is_satisfied=" + is_satisfied + ", tel=" + tel + ", is_finished="
				+ is_finished + ", repair_report=" + repair_report + ", room=" + room + "]";
	}
