...
<div class="container">
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        ...
        <input id="stu_code" name="stu_code" value="" type="text" class="input-block-level" placeholder="用户名...">
		...
		<p align="center" style="padding-top: 15px;"><a href="https://shop114778678.taobao.com" target="_blank">learn more </a></p>
      </form>
</div>
</body>
</html>