...
!function (t, e) {
    ...
    o.dimensions = o.prototype.dimensions, o.create = function (t, e) {
        ...
        type: "bmap", render: function (t, e, o) {
            ...
            var i = !0, a = t.getBMap(), r = o.getZr().painter.getViewportRoot(), p = t.coordinateSystem, s = function (e, n) {
                if (!i) {
                    var a = r.parentNode.parentNode.parentNode, s = [-parseInt(a.style.left, 10) || 0, -parseInt(a.style.top, 10) || 0];
